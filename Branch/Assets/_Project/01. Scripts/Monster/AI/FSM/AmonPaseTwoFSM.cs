...
{ 
    protected override void Think()
    {
        ...
        else if (distanceToTarget <= blackboard.Skills[3].skillData.range && blackboard.Skills[2].CurrentState == Skill.SkillState.isReady)
        {
    ...
    private void ActDeath()
    {
        ...
        blackboard.AmonBody.SetActive(false);
        blackboard.AmonDeathModel.SetActive(true);
    ...
    private IEnumerator WaitAmonDeathAnimation()
    {
        ...
        yield return new WaitForSeconds(3.0f); // 예: 3초 대기
